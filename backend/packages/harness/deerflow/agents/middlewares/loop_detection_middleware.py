...
_WARNING_MSG = (
    "[LOOP DETECTED] You are repeating the same tool calls. Stop calling tools and "
    "produce your final answer now. If you cannot complete the task, "
    "summarize what you accomplished so far."
)

_TOOL_FREQ_WARNING_MSG = (
    "[LOOP DETECTED] You have called {tool_name} {count} times without producing a "
    "final answer. Stop calling tools and produce your final answer now. "
...
_TOOL_FREQ_HARD_STOP_MSG = (
    "[FORCED STOP] Tool {tool_name} called {count} times — exceeded the per-tool safety "
